...
class Arrays2 // ***THE WORD AFTER CLASS MUST BE THE NAME OF THE FILE (BEFORE the .java) YOU SAVE THIS IN
{
	...
	*/
	...
	paintarray[0] = "", paintarray[1] = "Mona Lisa",paintarray[2] = "Water Lillies", paintarray[3] = "The Scream", paintarray[4] = "A Young rembrandt";	
	...
	vote [0]= 0,vote[1]= 0,vote[2]= 0,vote[3]= 0,vote[4]= 0;          
