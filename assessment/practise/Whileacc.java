...
class Whileacc // ***THE WORD AFTER CLASS MUST BE THE NAME OF THE FILE (BEFORE the .java) YOU SAVE THIS IN
{
    public static void main (String[] param)
    {

		whilelopz ();  // ***REPLACE THE WORD DOTHIS WITH THE NAME YOU USE BELOW
	...
	*/
    ...
    public static void whilelopz ()  // ***REPLACE THE NAME 'DOTHIS' WITH THE NAME YOU USED ABOVE
...
{ 
 ...
 JOptionPane.showInputDialog("Again? (y/n)  ");
