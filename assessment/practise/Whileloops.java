...
class Whileloops // ***THE WORD AFTER CLASS MUST BE THE NAME OF THE FILE (BEFORE the .java) YOU SAVE THIS IN
{
    public static void main (String[] param)
    {

		whileloop ();  // ***REPLACE THE WORD DOTHIS WITH THE NAME YOU USE BELOW
	...
	*/
    ...
    public static void whileloop ()  // ***REPLACE THE NAME 'DOTHIS' WITH THE NAME YOU USED ABOVE
