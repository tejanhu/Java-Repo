...
class chatbot3
{
	...
	{ 
        ...
        public static int askForFact(int i)
	{

       		String userfact(i) = JOptionPane.showInputDialog("Hi, what's 			your name?");
		String userfact2;
		...
		//Here are the first set of decision's, which give out a 			response depending on what the user previously inputs.
     		...
     		if(userfact1.equalsIgnoreCase("Yes"))
        	{
    	 	...
    	 	userfact2 = JOptionPane.showInputDialog(null, "I like 			football "+ "too " + userfact + ". Who do you support?");       
        	}
  
        	else 
        	{
	 	userfact2 = JOptionPane.showInputDialog(null, "How can 			you not like football. It's amazing" + userfact + ". You must 			have a team that you support?"); 
		}
		team(userfact, userfact2);
