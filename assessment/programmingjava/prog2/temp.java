   ...
   *************************************************** */
    ...
    */
    ...
    public static void squarethird()
    {
       ...
       //
       textinput = JOptionPane.showInputDialog("What is the temperature in degrees Fahrenheit?");
       ...
       //   
       JOptionPane.showMessageDialog(null, "The temperature is " + answer + "in Celsius.");
