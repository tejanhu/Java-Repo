...
class UseArrayLists15
// Shows constructively removing the integer before all occurrences of 
// an integer in an ArrayList
{
 public static void main(String[] args) throws Exception
 {
  ...
  ArrayList<Integer> b = removeBefore(a,p);
  System.out.println("\nThe result is "+b);
 }

 public static ArrayList<Integer> removeBefore(ArrayList<Integer> a,int m)
 // Removes the number which occurs before every occurrence of m in a, 
 // does this costructively
 {
  ArrayList<Integer> b = new ArrayList<Integer>();
  for(int i=0; i<a.size()-1; i++)
     if(!a.get(i+1).equals(m))
         b.add(a.get(i));
